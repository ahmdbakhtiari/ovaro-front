    ...
    return (
        <>
            ...
            {/* =========================
                Desktop Sidebar
            ========================== */}
            <aside className="sticky top-0 hidden h-screen w-[280px] shrink-0 border-l border-slate-200/70 bg-[#263238] lg:block">
                ...
                <div className="flex h-full flex-col px-5 py-7">
                    ...
                    >
                        ...
                        <div className="relative flex h-11 w-11 items-center justify-center rounded-[14px] bg-blue-600 text-white shadow-lg shadow-blue-600/20 transition duration-300 group-hover:scale-[1.03] group-hover:shadow-blue-600/30">
                    ...
                    <div className="px-2">
                        ...
                        <p className="text-right text-[10px] font-bold uppercase tracking-[0.18em] text-white">
                            منو اصلی
                        </p>
                        ...
                        {navigation.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    href={item.href}
                                    dir="rtl"
                                    className={`group relative flex items-center gap-3 rounded-xl px-3.5 py-3 text-[13px] font-semibold transition-all duration-200 ${isActive
                    ...
                    {/* AI Model Status */}
                    <div className="relative overflow-hidden rounded-2xl bg-slate-950 p-4 shadow-xl shadow-slate-900/10">
